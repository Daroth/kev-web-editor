 ...
 */
class ChannelTypeImpl : org.kevoree.container.KMFContainerImpl, org.kevoree.ChannelType { 
...
public override var lowerBindings : Int? = null
	 set(iP : Int?){
internal_lowerBindings(iP, true)
	}//end of setter

	private fun internal_lowerBindings(iP : Int?, fireEvents : Boolean = true){
if(isReadOnly()){throw Exception(org.kevoree.util.Constants.READ_ONLY_EXCEPTION)}
if(iP != lowerBindings){
val oldPath = path()
$lowerBindings = iP
if(fireEvents) {
fireModelEvent(org.kevoree.modeling.api.events.ModelEvent(oldPath, org.kevoree.modeling.api.util.ActionType.SET, org.kevoree.modeling.api.util.ElementAttributeType.ATTRIBUTE, org.kevoree.util.Constants.Att_lowerBindings, lowerBindings))
}
	}
	}//end of setter
public override var upperBindings : Int? = null
	 set(iP : Int?){
internal_upperBindings(iP, true)
	}//end of setter

	private fun internal_upperBindings(iP : Int?, fireEvents : Boolean = true){
if(isReadOnly()){throw Exception(org.kevoree.util.Constants.READ_ONLY_EXCEPTION)}
if(iP != upperBindings){
val oldPath = path()
$upperBindings = iP
if(fireEvents) {
fireModelEvent(org.kevoree.modeling.api.events.ModelEvent(oldPath, org.kevoree.modeling.api.util.ActionType.SET, org.kevoree.modeling.api.util.ElementAttributeType.ATTRIBUTE, org.kevoree.util.Constants.Att_upperBindings, upperBindings))
}
	}
	}//end of setter
public override var lowerFragments : Int? = null
	 set(iP : Int?){
internal_lowerFragments(iP, true)
	}//end of setter

	private fun internal_lowerFragments(iP : Int?, fireEvents : Boolean = true){
if(isReadOnly()){throw Exception(org.kevoree.util.Constants.READ_ONLY_EXCEPTION)}
if(iP != lowerFragments){
val oldPath = path()
$lowerFragments = iP
if(fireEvents) {
fireModelEvent(org.kevoree.modeling.api.events.ModelEvent(oldPath, org.kevoree.modeling.api.util.ActionType.SET, org.kevoree.modeling.api.util.ElementAttributeType.ATTRIBUTE, org.kevoree.util.Constants.Att_lowerFragments, lowerFragments))
}
	}
	}//end of setter
public override var upperFragments : Int? = null
	 set(iP : Int?){
internal_upperFragments(iP, true)
	}//end of setter

	private fun internal_upperFragments(iP : Int?, fireEvents : Boolean = true){
if(isReadOnly()){throw Exception(org.kevoree.util.Constants.READ_ONLY_EXCEPTION)}
if(iP != upperFragments){
val oldPath = path()
$upperFragments = iP
if(fireEvents) {
fireModelEvent(org.kevoree.modeling.api.events.ModelEvent(oldPath, org.kevoree.modeling.api.util.ActionType.SET, org.kevoree.modeling.api.util.ElementAttributeType.ATTRIBUTE, org.kevoree.util.Constants.Att_upperFragments, upperFragments))
}
	}
	}//end of setter
...
org.kevoree.util.Constants.Att_lowerBindings -> {
this.internal_lowerBindings((value as? Int), fireEvents)
}
org.kevoree.util.Constants.Att_upperBindings -> {
this.internal_upperBindings((value as? Int), fireEvents)
}
org.kevoree.util.Constants.Att_lowerFragments -> {
this.internal_lowerFragments((value as? Int), fireEvents)
}
org.kevoree.util.Constants.Att_upperFragments -> {
this.internal_upperFragments((value as? Int), fireEvents)
}
...
override fun visitAttributes(visitor : org.kevoree.modeling.api.util.ModelAttributeVisitor){
            visitor.visit(upperFragments,org.kevoree.util.Constants.Att_upperFragments,this)
            ...
            visitor.visit(upperBindings,org.kevoree.util.Constants.Att_upperBindings,this)
            visitor.visit(lowerBindings,org.kevoree.util.Constants.Att_lowerBindings,this)
            visitor.visit(bean,org.kevoree.util.Constants.Att_bean,this)
            visitor.visit(lowerFragments,org.kevoree.util.Constants.Att_lowerFragments,this)
...
return org.kevoree.util.Constants.org_kevoree_ChannelType;
}
override public fun getUpperFragments() : Int? { return upperFragments}
override public fun setUpperFragments(internal_p : Int?) { upperFragments = internal_p }
...
override public fun getUpperBindings() : Int? { return upperBindings}
override public fun setUpperBindings(internal_p : Int?) { upperBindings = internal_p }
override public fun getLowerBindings() : Int? { return lowerBindings}
override public fun setLowerBindings(internal_p : Int?) { lowerBindings = internal_p }
override public fun getBean() : String? { return bean}
override public fun setBean(internal_p : String?) { bean = internal_p }
override public fun getLowerFragments() : Int? { return lowerFragments}
override public fun setLowerFragments(internal_p : Int?) { lowerFragments = internal_p }
