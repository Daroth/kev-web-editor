...
var buf = [];
with (locals || {}) {
buf.push("<div class=\"row-fluid\"><div class=\"row-fluid\"><div class=\"span4\">Instance name</div><input" + (jade.attrs({ 'id':('instance-attr-name'), 'type':('text'), 'placeholder':('Name'), 'value':(name), "class": ('span8') }, {"type":true,"placeholder":true,"value":true})) + "/></div>" + (null == (jade.interp = attrsHTML) ? "" : jade.interp) + "</div>");
if ( nodes.length > 0)
{
